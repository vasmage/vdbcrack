...
#pragma omp parallel for
        ...
        // CHEF NOTE: remove_ids() w/ Hashtable is O(ids to remove)
        //  - it finds location in invlist where embedding is
        //  - replaces it with last embedding in list
        //  - resizes list ( -= 1)
        // TODO: .reorg() if you know assignments & have this Hashtable
        //      - have a .move() where you move points from one list to another
        //      - then you .remove() them from their original location
        //      - MAYBE: if you do .resize() once it's cheaper? idk
        FAISS_THROW_IF_MSG(
                block_invlists,
