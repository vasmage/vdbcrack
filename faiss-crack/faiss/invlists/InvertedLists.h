...
struct InvertedLists {
    ...
    // CHEF: apparently this is for PQ ( i read somewhere )
    ...
    virtual void update_entry(
            ...
            idx_t id,
            const uint8_t* code);
    // CHEF: Figure out what this does and if I can use it
    ...
    // CHEF: this is needed even if ArrayInvertedLists is the one implementing it 
    // if you add it here the other subclasses complain for lacking implementation
    //     virtual void add_empty_list();
    ...
    // CHEF: move entries from one invlist to another? 
    //  - CHEF NOTE: but I think they need to have the same quantizer or something?
     ...
     */
    // CHEF TODO: Figure out what this is and if it helps 
...
struct ArrayInvertedLists : InvertedLists {
    ...
    /// Add an empty inverted list
    //CHEF TODO: Use this for cracking?
    void add_empty_list();
